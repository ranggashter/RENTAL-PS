            ...
            <form action="<?= base_url('welcome/start'); ?>" method="POST">
                <div class="modal-body">
                    ...
                    <select name="waktu" class="form-select form-select-sm text-white" id="pilih_paket" disabled>
                        ...
                        <option value="M">main 30 menit</option>
                        <option value="A">main 1 Jam</option>
                        <option value="C">main 2 Jam</option>
                        <option value="E">main 3 Jam</option>
                        <option value="G">main 4 Jam</option>
                        <option value="L">main 5 Jam</option>
                        <option value="AA">main diskon 1 Jam</option>
                        <option value="CC">main diskon 2 Jam</option>
                        <option value="EE">main diskon 3 Jam</option>
                        <option value="GG">main diskon 4 Jam</option>
                        <option value="LL">main diskon 5 Jam</option>
                        <option value="K">main paket 3 + 1 jam</option>
                        
                        
                        <!-- <option value="K">3+1 Jam</option> -->
                    </select>
                    <script>
                        $('#pilih_paket').hide()
